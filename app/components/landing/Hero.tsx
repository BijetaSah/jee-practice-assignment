...
function Hero() {
  return (
    <section className="py-10 px-5 sm:px-10 md:px-15 flex flex-col items-center gap-5">
      <h2 className=" text-blue-700 font-bold text-4xl flex gap-2 items-center">
        JEE Practice Questions <FaPenAlt className="text-base" />
      </h2>
      ...
      <div className=" mt-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          {features.map(({ id, title, description, icon: Icon }) => (
            <div
              key={id}
              className="flex  flex-col items-center gap-2 bg-blue-100 px-5 py-8 rounded-xl"
            >
